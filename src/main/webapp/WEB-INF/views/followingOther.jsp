...
<div class="follow_msg_div">
    <h4>💙 '${member_id}'님의 팔로잉 💙</h4>
</div>
<div class="follow_nav_div2">
    <ul class="nav nav-underline">
        <li class="nav-item nav_bottom_border">
            <a class="nav-link" href="/catstagram/${member_id}/follower">팔로워</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/catstagram/${member_id}/following">팔로잉</a>
        </li>
    </ul>
</div>
