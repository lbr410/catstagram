...
<body>
	<form class="login_form" action="" method="post">
		...
		<div class="id_input_div"><input type="text" name="member_id" placeholder="아이디" class="id_input" maxlength="30"></div>
		<div class="pwd_input_div"><input type="password" name="member_pwd" placeholder="비밀번호" class="pwd_input" maxlength="12"></div>
		...
		<div class="pwd_result_div" id="pwd_result">잘못된 비밀번호입니다. 다시 확인하세요.</div>
	</form>
